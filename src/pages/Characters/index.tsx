...
export const Characters: React.FC = () => {
  ...
  const handlePageChange = (event: {selected: number}) => getCharacters(event.selected + 1, search);
      ...
      <Main>
        ...
        <Container>
          ...
          <div className="row justify-content-end mb-3">
            <div className="col-3">
             <SearchInput onSearch={handleSearch} placeholder="Search Characters" />
            </div>
          </div>
          <LoadingGate
          ...
          >           
            <div className="row row-cols-1 row-cols-sm-2 row-cols-md-2 row-cols-lg-4 g-2 mb-5">
              {characters.map((character) => (
                <div key={character.id} className="col d-flex">
